...
@section ("content")
    ...
    <form method="POST" action="/breweries/add">
        ...
        <div class="input-group">
        <span class="input-group-addon" id="basic-addon1">Brewery Name</span>
            <div class="rating-box form-control"><input id="input-id" type="number" class="rating" name="rating" value="{{ old("rating", "4") }}" min=0 max=10 step=1 data-show-caption="false" data-size="xs" ></div>
        </div>
        <br>

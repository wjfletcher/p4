...
<div class="panel panel-default">
    <div class="panel-body">
        <h1>Edit Beer</h1> @if(count($errors) > 0)
        <ul class='errors'>
        ...
        <form method="POST" action="/beers/edit">
            ...
            <div class="input-group">
                ...
                <div class="rating-box form-control">
                    <input id="input-id" type="number" class="rating" name="rating" value="{{ $beer->rating }}" min=0 max=10 step=1 data-show-caption="false" data-size="xs">
                </div>
            </div>
            <br>
            <div class="input-group">
